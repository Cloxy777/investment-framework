...
- **Same ticker resolution as before:** Trainline plc, LSE:TRN, IBKR contract_id 371871705, yfinance `TRN.L` — confirmed correct entity (4 unrelated companies share the "TRN" symbol; see [TRN-2026-06-22.md](../watchlist/in-portfolio/TRN/TRN-2026-06-22.md) §0 for the full disambiguation, unchanged and re-confirmed here).
