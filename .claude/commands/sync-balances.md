...
4. Push to a `claude/`-prefixed branch: stage `ibkr.md` and `holdings.md`, commit with the message `Sync IBKR cash balances — YYYY-MM-DD`, open a PR with that same title, and enable auto-merge (squash) on it.
