...
**Conscious divergence on record — the Speculation Module (added 2026-07-01).** [speculation-module.md](speculation-module.md) knowingly fails the price-action and turnover tests above — trades inside it are explicitly triggered by price/news moves and options pricing, and exist to increase turnover without a fundamental change each time. Recorded here as deliberate, not an oversight: Graham himself (Buffett's own teacher) carved out this exact exception — a small, separate "mad money" account, capped, never mingled with the core book — and this module's fence is tighter than his (a 5% proposed cap vs. his 10%, plus a quality-gated universe he didn't require). The core book's 100%-fundamentals discipline survives *because* the sleeve is walled off and capped, not because price-action decisions never happen anywhere in the portfolio. See [decisions/2026-07-01-framework-change-speculation-module.md](../decisions/2026-07-01-framework-change-speculation-module.md).
